    ...
    <div className="grid" style={{ gap: 16 }}>
      <div className="card" style={{ display: 'flex', gap: 26, flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <p className="muted" style={{ margin: '6px 0 0', maxWidth: 720 }}>
            ...
            bài tập thực hành trên chính web này và trắc nghiệm chấm tự động.
          </p>
        </div>
        {progress && (
          <div style={{ display: 'flex', gap: 22 }}>
            ...
            <div className="center">
              <div className="muted" style={{ fontSize: 12 }}>ĐIỂM TB</div>
          ...
          <div key={level} className="card">
            ...
            <div className="grid" style={{ gap: 10 }}>
              {items.map((l) => {
                ...
                const score = l.progress?.quizScore
                return (
                  <Link
                    key={l.id}
                    to={`/learn/${l.id}`}
                  ...
                  >
                    ...
                    <span className="muted" style={{ fontSize: 12, flexShrink: 0 }}>
                      ⏱ {l.minutes}′ · 📝 {l.quizCount} câu
                    </span>
                    {done && <span className="badge green">✓ Đã đọc</span>}
                    {score != null && (
                      <span className={`badge ${score / l.progress.quizTotal >= 0.6 ? 'green' : 'amber'}`}>
                        {score}/{l.progress.quizTotal}
                      </span>
                    )}
      ...
      <div className="card">
        ...
        <p className="muted" style={{ margin: 0, fontSize: 13.5 }}>
          Học đúng thứ tự 1 → 15. Mỗi tuần 2 bài là nhịp phù hợp: đọc bài → làm bài tập "Thực hành trên web" → làm trắc
          nghiệm (đạt ≥ 60%) → áp dụng vào 1 lệnh giả lập. Sau Bài 12, hãy tự phân tích 1 mã thật từ đầu đến cuối theo{' '}
